...
Ищи новые ЖК/корпуса/старты продаж с видом на реку, залив, парк или панораму,
а также новые участки у воды. Бюджет не задан. Не включай другие регионы.
Приоритет: конкретный подтвержденный старт, реальный вид, цена конкретного лота.
...
Каждая карточка: source_id (целое), title (название проекта), category (ЖК или Земля),
